...
fn test_detect_mime_type_ext() {
    ...
    assert_eq!(detect_mime_type_ext("foo.js"), Some("application/javascript"));
...
fn test_detect_mime_type_magic() {
    ...
    assert_eq!(detect_mime_type_magic(b"<!DOCTYPE html><title>test"), Some("text/html"));

    assert_eq!(detect_mime_type_magic(b"<?xml version=\"1.0\" encoding=\"utf-8\">\n<!DOCTYPE html>"), Some("application/xhtml+xml"));
